...
num_pages = 360  # Number of pages to scrape
...
for page_num in range(num_pages):
    ...
    next_page_element = driver.find_element(By.XPATH, '//a[@href="/airline-reviews/british-airways/page/{}/"]'.format(page_num + 2))
...
df.to_csv('airline_reviews_o.csv', index=False)
